...
namespace InternetDatabase.Migrations
{
    ...
    [Migration("20240911022458_account_cc")]
    partial class account_cc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternetDatabase.EntityDB.AccountCryptoCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternetDatabase.EntityDB.TelegramUser", b =>
                {
                    ...
                    b.Property<decimal>("BalanceTemp")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("InternetDatabase.EntityDB.Wallet", b =>
                {
                    ...
                    b.Property<int?>("AccountCryptoCardId")
                        .HasColumnType("int");

                    b.Property<decimal>("BalanceBoost")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.Property<string>("CryptoCardId")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("AccountCryptoCardId");
            ...
            modelBuilder.Entity("InternetDatabase.EntityDB.Wallet", b =>
                {
                    b.HasOne("InternetDatabase.EntityDB.AccountCryptoCard", "AccountCryptoCard")
                        .WithMany("Wallets")
                        .HasForeignKey("AccountCryptoCardId");

                    b.HasOne("InternetDatabase.EntityDB.TelegramUser", "TelegramUser")
                        .WithMany("Wallets")
                        .HasForeignKey("TelegramUserId");

                    b.Navigation("AccountCryptoCard");
